...
CREATE USER spring_sym IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_sym;

ALTER USER spring_sym DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
UPDATE "MEMBER" SET MEMBER_PW = '$2a$10$LhVXCGh4ybaAAXeYEZ3dv.KmTaX2dLnxu46kH5RBuvvcnHHkLQSWS'
WHERE MEMBER_NO = '1';
